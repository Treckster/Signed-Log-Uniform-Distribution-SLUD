...
seed        = 4111                # Random seed for reproducibility

decade_selector = SLUD      # Decade selector, can be LUD; SLUD; LIN
functoeval      = 'poly7'   # Function to evaluate, can be 'rosen', 'brown', 'powell', 'poly7'
...
elif functoeval == 'poly7': # fobjt=0 ; xopt = [2.11265971e-12, -6.12806624e-09, 6.64306396e-06, -3.27931884e-03, 3.1682671] 
    evalfunc = funcs.poly7  # Import the Polynomial function from funcs.py
    fobjmin = 1e-6  # Objective function minimum value
    if decade_selector == LUD:
        # Number of variables
        n_vars = 10
...
print(f"Evaluating {functoeval} with {n_vars} variables")
